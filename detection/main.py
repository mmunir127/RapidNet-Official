...
import rapidnet_backbone


parser = argparse.ArgumentParser(description='Train a detector')
parser.add_argument('config', help='train config file path')
parser.add_argument('--work-dir', help='the dir to save logs and models')
parser.add_argument('--rapidnet_model', default='RapidNet_M', type=str, metavar='MODEL',
                help='Name of model to train (default: "RapidNet_M"')
parser.add_argument(
...
print(args)
print("\n rapidnet_model = " + str(args.rapidnet_model))
