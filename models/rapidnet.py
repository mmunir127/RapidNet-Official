...
@register_model
def RapidNet_Ti(pretrained=False, **kwargs):
    model = RapidNet(blocks=[[2,0], [2,0], [6,2], [2,2]],
                      channels=[32, 64, 112, 224],
                      dropout=0.,
                      drop_path=0.1,
                      emb_dims=512,
                      distillation=True,
...
@register_model
def RapidNet_S(pretrained=False, **kwargs):
...
@register_model
def RapidNet_M(pretrained=False, **kwargs):
    model = RapidNet(blocks=[[3,0], [3,0], [9,3], [3,3]],
...
@register_model
def RapidNet_B(pretrained=False, **kwargs):
    model = RapidNet(blocks=[[3,0], [3,0], [9,3], [3,3]],
