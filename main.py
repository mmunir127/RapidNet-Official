...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'RapidNet training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--gradient_accumulation', default=False, type=bool) 
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='RapidNet_Ti', type=str, metavar='MODEL',
...
def main(args):
    ...
    train_loss = LabelSmoothingCrossEntropy()

    if args.mixup > 0.:
        train_loss = SoftTargetCrossEntropy()
    elif args.smoothing:
        train_loss = LabelSmoothingCrossEntropy(smoothing=args.smoothing)
    else:
    ...
    train_loss = DistillationLoss(
        train_loss, teacher_model, args.distillation_type, args.distillation_alpha, args.distillation_tau
    )
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'RapidNet training and evaluation script', parents=[get_args_parser()])
